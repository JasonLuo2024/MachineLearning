...
save_path = '/home/hluo/results/Estern_Health_Age/'
class PNGDataset(Dataset):
    ...
    def __getitem__(self, idx):
        try:
            ...
            os.remove(self.CC_image_list[idx])

        try:
            img_2 = Image.open(self.MLO_image_list[idx]).convert('RGB')
        except Exception:
            os.remove(self.MLO_image_list[idx])
...
def main():
    dataset = PNGDataset(r'/home/hluo/Eastern_Health_Age', transform=transform)
    ...
    for epoch in tqdm(range(num_epochs)):
        ...
        try:
            ...
            try:
                ...
                torch.save(model.state_dict(), save_path + str(epoch) + 'Test.pth')
