...
@click.option('--resume',       help='Resume from given network pickle', metavar='[PATH|URL]',  type=str) # add default if needed
...
def main(**kwargs):
    ...
    c.D_kwargs = dnnlib.EasyDict(class_name='training.networks_stylegan2.Discriminator',
    ...
    if opts.aug != 'noaug':
        c.augment_kwargs = dnnlib.EasyDict(class_name='training.augment.AugmentPipe', xflip=1, rotate90=1, xint=1,
                                           scale=1, rotate=1, aniso=1, xfrac=1, brightness=1, contrast=1,
