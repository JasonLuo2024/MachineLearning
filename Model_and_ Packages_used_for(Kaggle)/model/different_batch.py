...
def main():
    ...
    train_dataloader = DataLoader(train_dataset, batch_size=18, shuffle=True, num_workers=16)
    ...
    for epoch in tqdm(range(num_epochs)):
        ...
        try:
            ...
            torch.save(model.state_dict(), r'/home/hluo/results/batch_size_6/' + str(epoch) + 'Test.pth')
            ...
            df.to_csv(r'/home/hluo/results/batch_size_6/' + 'output_' + str(epoch) + '.csv', index=False)
            ...
            output_file = r'/home/hluo/results/batch_size_6/' + str(epoch) + 'metrics.txt'
